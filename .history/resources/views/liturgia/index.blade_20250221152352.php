...
<body>
    <div class="container mt-5 border-solid-danger">
        <div class="title">Leccionário Dominical</div>
        ...
        @if ($liturgia)
            <div class="text-center mt-3">
                ...
                <p><strong>Cor Litúrgica:</strong> <span style="color: {{ $liturgia['cor'] }}; font-weight: bold;">{{ $liturgia['cor'] }}</span></p>
            </div>

            <div class="section-title">Primeira Leitura</div>
            ...
            @if(!empty($liturgia['segundaLeitura']['referencia']) && $liturgia['segundaLeitura']['texto'] !== "Não há segunda leitura hoje!")
                <div class="section-title">Segunda Leitura</div>
            ...
            <div class="section-title">Evangelho</div>
